...
func _ready(): # calls function when game is started
...
func flashcards(_wave): # function called after player has cleared enemy wave, starts flashcards
	gamestate = 2 # sets gamestate to 2, gamestate 2 = flashcards portion of program
...
func cards_done(): # function called after player has done flashcards
	gamestate = 1 # sets gamestate to 1, gamestate 1 = space invaders portion of program
	...
	enemy.spawn_wave() # spawns enemies
